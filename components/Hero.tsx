...
const Hero = () => {
  return (
    <section className="flex min-h-screen flex-col items-center justify-center gap-x-20 py-20 md:flex-row md:py-0">
      <div className="flex flex-1 flex-col items-center justify-center px-3 text-center md:block md:px-0 md:text-left">
        ...
        <button className="mt-10 rounded-sm bg-gradient-to-tr from-orange-500 to-fuchsia-500 px-10 py-3 text-white">
          Services
        </button>
      </div>
